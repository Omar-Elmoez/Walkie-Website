    ...
    <>
      ...
      <div className="welcomeDiv">
        <div className="welcomeDiv__content">
          <h2 className="welcomeDiv__heading">
            welcome to <span>Ismalia</span> mahmoud....
          </h2>
          <p className="welcomeDiv__para">
            <span>Welcome</span> to our beautiful city! We're excited to have
            you here. Explore our local attractions, taste our delicious
            cuisine, and immerse yourself in our unique culture. Enjoy your
            visit and make unforgettable memories !
          </p>
        </div>
      </div>
      <Places content="1" />
